  ...
  return (
    <div className="min-h-screen bg-cream text-ink relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-8 pt-8 pb-24">
        ...
        {/* Hero */}
        <div className="mb-14">
          <span className="text-xs font-bold text-ink-faint uppercase tracking-[0.18em] mb-4 block">
            the fine print
          </span>
          <h1 className="text-4xl md:text-5xl font-bold text-ink leading-tight mb-4 tracking-[-0.02em] flex items-center gap-4">
            terms of service{" "}
            <FileText
              className="w-9 h-9 text-blush shrink-0"
              strokeWidth={2.5}
            />
          </h1>
          <p className="text-ink-soft text-lg leading-relaxed max-w-xl">
            Short, honest, and actually readable. By using whimsical, you agree
            to these — but really it's just common sense stuff.
          </p>
        ...
        <div className="mt-14 pt-8 border-t border-line text-center">
          <p className="text-ink-soft text-sm leading-relaxed max-w-md mx-auto">
            Still confused? Totally fair — legal stuff is confusing. Just reach
            out and we'll explain in plain words.
          </p>
          <a
          ...
          <p className="mt-6 text-xs font-bold text-ink-faint uppercase tracking-[0.2em]">
            made with{" "}
            <Heart size={11} className="inline text-blush fill-current" /> 2026
            whimsical
          </p>
        </div>
      </div>

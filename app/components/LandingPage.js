    ...
    <div className="min-h-screen bg-cream text-ink relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-8 pt-10 sm:pt-16 pb-16 sm:pb-24">
              ...
              {TUTORIALS.map((c, i) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-ink/30 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center backdrop-blur-[2px]">
                    <span className="text-white font-bold tracking-[0.15em] uppercase text-xs border border-white/40 px-4 py-2 rounded-full bg-ink/20 shadow-sm">
                      Read Entry
                    </span>
                  </div>
                </div>
          ...
          <section className="mb-14 sm:mb-24">
            <div className="relative overflow-hidden rounded-3xl border border-line shadow-sm bg-gradient-to-br from-blush-light/50 via-cream to-honey-light/30 px-5 sm:px-8 py-8 sm:py-12 flex flex-col md:flex-row gap-6 sm:gap-10 items-center">
              ...
              <div className="shrink-0 flex flex-col items-center gap-3">
                ...
                <span className="text-xs font-bold text-ink-faint uppercase tracking-[0.18em]">
                  the story
                </span>
              </div>
              {/* Content */}
              <div className="flex-1">
                <p className="font-bold text-3xl md:text-4xl text-ink mb-4 leading-tight">
                  hey,
                  <br />
                  it's me! 👋
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {[
                    ...
                    <span
                      key={t.label}
                      className={`px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider border ${t.color}`}
                    >
                      {t.label}
                    </span>
                  ))}
          ...
          {/* What you can do */}
          <section className="mb-14 sm:mb-24">
            <span className="text-xs font-bold text-ink-faint uppercase tracking-[0.18em] mb-5 sm:mb-8 block">
              what you can do
            </span>
              ...
              {[
                {
                  ...
                  iconColor: "text-[#8B6914] bg-honey/15",
                },
                {
                  icon: NotebookPen,
                  ...
                  iconColor: "text-blush bg-blush/15",
                },
                {
                  icon: Highlighter,
                ...
                },
                {
                  ...
                  iconColor: "text-lavender bg-lavender/15",
                },
              ].map((f) => (
                <div
                  key={f.title}
                  className={`rounded-2xl border-2 ${f.accent} p-6 flex gap-4 items-start`}
                >
                  <span
                    className={`shrink-0 mt-0.5 w-10 h-10 rounded-xl flex items-center justify-center ${f.iconColor}`}
                  >

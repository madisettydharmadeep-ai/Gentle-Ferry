...
export default function CameraCropper({ rawImage, onCrop, onCancel }) {
  ...
  const handlePointerMove = (e) => {
    ...
    const maxX = Math.max(0, width / 2 - 114);
    const maxY = Math.max(0, height / 2 - 114);
  ...
  const triggerShutter = () => {
    ...
    setTimeout(async () => {
      ...
      const cssX = renderW / 2 + cameraPos.x - 114;
      const cssY = renderH / 2 + cameraPos.y - 114;
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden rounded-lg">
          ...
          <div
            ...
            style={{ height: `calc(50% + ${cameraPos.y}px - 114px)` }}
          />
          {/* Bottom mask */}
          <div
          ...
          <div
            ...
            style={{
              top: `calc(50% + ${cameraPos.y}px - 114px)`,
              bottom: `calc(50% - ${cameraPos.y}px - 114px)`,
              width: `calc(50% + ${cameraPos.x}px - 114px)`,
            }}
          />
          {/* Right mask */}
          <div
        ...
        <div
          className="absolute top-1/2 left-1/2 w-[260px] h-[260px] pointer-events-none z-20 flex flex-col items-center justify-center group"
          style={{
        ...
        >
          ...
          >
            ...
            <div className="absolute top-[28px] right-[28px] flex items-center gap-1 opacity-90 pointer-events-none">
              <span className="text-[0.4rem] font-bold text-white uppercase tracking-[0.2em] drop-shadow-md">
                Focus
              </span>
